...
from services import subscribe, utils
...
@router.get('/card/{subscribe_id}/', dependencies=[Depends(utils.check_auth_key)])
...
@router.get('/topup/{user_id}/', dependencies=[Depends(utils.check_auth_key)])
