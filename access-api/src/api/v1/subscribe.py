...
@router.post('/buy/from_balance', response_model=GrantedAccess, dependencies=[Depends(utils.check_auth_key)])
...
@router.get('/check/{movie_uuid}/{user_uuid}', dependencies=[Depends(utils.check_auth_key)])
